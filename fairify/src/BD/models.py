...
def model7(input_dim):
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(16, activation=tf.keras.layers.LeakyReLU(alpha=talpha)),
        tf.keras.layers.Dense(8, activation='relu'),
        tf.keras.layers.Dense(4, activation=tf.keras.layers.LeakyReLU(alpha=talpha)),
        tf.keras.layers.Dense(1, activation='sigmoid')
    ])
...
def model9(input_dim):
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(6, activation=tf.keras.layers.LeakyReLU(alpha=talpha)),
        tf.keras.layers.Dense(3, activation='relu'),
        tf.keras.layers.Dense(1, activation='sigmoid')
    ])
...
def model11(input_dim):
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(10, activation='relu'),
        tf.keras.layers.Dense(15, activation=tf.keras.layers.LeakyReLU(alpha=talpha)),
        tf.keras.layers.Dense(10, activation='relu'),
        tf.keras.layers.Dense(1, activation='sigmoid')
    ])
